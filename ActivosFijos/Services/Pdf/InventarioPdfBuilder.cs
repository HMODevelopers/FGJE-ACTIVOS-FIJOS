...
{
    public class InventarioPdfBuilder
    {
        public void RenderTablaActivos(Document document, List<PLU_OP_InventarioFisico> activos)
        {
        ...
        public void RenderTablaActivos2(Document document, List<PLU_OP_InventarioFisico> activos)
        {
            PdfPTable bienesTable = new PdfPTable(8);
            bienesTable.WidthPercentage = 100;
